    ...
    <script>
        $(document).ready(function () {
            ...
            $("#id").keyup(function () { // id입력 상자에 id값 입력시
                ...
                $.ajax({
                    type: "POST", //필수
                    url: "check_id.php", //필수 넘어갈페이지   *링크가 아닌* 현재페이지에 머물러 파일에 접근
                    data: "id=" + id, //필수 넘어갈 매개변수
                    cache: false, //저장정보
                    success: function (data) //성공했다 
                    {
                        //data => echo "문자열" 이 저장된
                        $("#loadtext").html(data); //
                    }
        ...
        <form name="member_form" method="post" action="insert.php">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="id" id="id" placeholder="아이디(8자이내로 입력)" required>
                        <div id="loadtext">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <label class="hidden" for="hp2">전화번호중간4자리</label><input type="text" class="hp" name="hp2"
                            id="hp2" required> - <label class="hidden" for="hp3">전화번호끝4자리</label><input type="text"
                            class="hp" name="hp3" id="hp3" required>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="email1" name="email1" placeholder="이메일" required> @

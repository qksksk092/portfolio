...
<head>
    ...
    @extract($_SESSION);
      ...
      $start = ($page - 1) * $scale;      //읽어올 레코드의 인덱스번호
  
      $number = $total_record - $start;//출력할 레코드 번호
  ?>
            ...
            <div class="content_area">
                ...
                <form name="board_form" method="post" action="list.php?mode=search">
                    <div class="list_searchs">
                        ...
                        <input class="in1" type="text"id="search"  name="search"placeholder="검색어를 입력해주세요."></div>
                        <div class="list" id="list_search5">
                        <label for="search_btn" class="hidden">검색버튼</label>
                        <input type="submit" id="search_btn" value="검색"></div>
                    </div>
                    <div id="list_search">
                ...
                <div id="list_content">
                    <?		
                       for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)                    
                       {
                          ...
                          $item_date = substr($item_date, 0, 10);  //substr 글자가져오기   2021-07-21
                                      
                          $item_subject = str_replace(" ", "&nbsp;", $row[subject]);//str_replace 문자열 바꾸는 메소드

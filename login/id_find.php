...
<script>
	$(document).ready(function() {
         ...
         $(".find").click(function() {    // id입력 상자에 id값 입력시
            ...
            var hp1 = $('#hp1').val(); //010
            var hp2 = $('#hp2').val(); //2222
            var hp3 = $('#hp3').val(); //3333

            $.ajax({
                type: "POST",
                url: "find.php", /*매개변수인 check_id.php파일을 post방식으로 넘기세요*/
                data: "name="+ name+ "&hp1="+hp1+ "&hp2="+hp2+ "&hp3="+hp3,  /*넘겨주는 값, 매개변수id도 같이 넘겨줌*/
                cache: false, 
            ...
            $("#loadtext").addClass('loadtexton');//css변경
        }); 
...
<body>
    <div id="wrap">
    <h1><a href="../index.html" class="logo">무림페이지</a></h1>
	<div id="col2">
				...
				<div id="id_input_button">
					<fieldset>
                        ...
                        <div class="telBox">
                            ...
                            <input class="find_input" type="text" id="hp2" name="hp2" title="연락처 가운데4자리를 입력하세요." maxlength="4"> - 
                            <label class="hidden" for="hp3">연락처 마지막4자리</label>
                            <input class="find_input" type="text" id="hp3" name="hp3" title="연락처 마지막4자리를 입력하세요." maxlength="4" >
                        </div>
